...
import (
	...
	"github.com/hfyeh/runtime/virtcontainers/pkg/firecracker/client"
	models "github.com/hfyeh/runtime/virtcontainers/pkg/firecracker/client/models"
	ops "github.com/hfyeh/runtime/virtcontainers/pkg/firecracker/client/operations"
...
func (fc *firecracker) createSandbox(ctx context.Context, id string, networkNS NetworkNamespace, hypervisorConfig *HypervisorConfig, stateful bool) error {
	...
	//https://github.com/hfyeh/runtime/issues/1065
	...
	// https://github.com/hfyeh/runtime/issues/1869
	fc.uid = "0"
	fc.gid = "0"
...
func (fc *firecracker) fcInit(timeout int) error {
	...
	if fc.jailed {
		jailedArgs := []string{
			...
			"--uid", "0", //https://github.com/hfyeh/runtime/issues/1869
			"--gid", "0",
